...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            EventStep stepEvent = new EventStep(true, stepHeight);
            if (this == Minecraft.getMinecraft().thePlayer)
                EventBus.getInstance().call(stepEvent);

            if (this.stepHeight > 0.0F && stepEvent.getStepHeight() > 0.0F && flag1 && (d3 != x || d5 != z))
            {
                double d11 = x;
                double d7 = y;
                double d8 = z;
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z) {
                    ...
                    EventBus.getInstance().call(new EventStep(false, stepHeight, 1 + y));
                }
            }
