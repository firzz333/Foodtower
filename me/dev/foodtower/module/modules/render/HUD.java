...
//    public static final ResourceLocation jigsawTexture512 = new ResourceLocation("foodtower/JIGSAW512.png");
    ...
    private final Mode<Enum<Logo>> logo = new Mode<>("Logo", "logo", Logo.values(), Logo.Text);
    ...
    private void renderHud(EventRender2D event) {
        ...
        if (mode.getValue() == HUDMode.FoodTower) {
            ...
            if (!mc.gameSettings.showDebugInfo) {
                ...
                } else if (logo.getValue() == Logo.Icon) {
                    RenderUtil.drawImage(new ResourceLocation("foodtower/icon.png"), 7, 10, 64, 64);
                }
